...
class PomodoroTimer:
    ...
    def __init__(
        ...
        *,
        ...
        if active_limit_ms < 0:
            raise ValueError("active_limit_ms は 0 以上にしてください")
    ...
    def snapshot(self) -> TimerSnapshot:
        ...
        remaining = max(0, math.ceil(self.work_threshold_sec - self.active_seconds))
        ratio = min(1.0, self.active_seconds / self.work_threshold_sec)
